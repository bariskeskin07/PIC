...
void main(){
   ...
   UART1_Init(57600);                    // EUSART donanýmý yapýlandýrýldý
   Delay_ms(100);                        // Baud hýzý 57600 belirlendi

   UART1_Write_Text("PIC18F4550 & EUSART uygulamasina hosgeldiniz!.");
   UART1_Write(13);                      // EUSART ile ENTER gönderildi
   UART1_Write_Text("11/07/2011   Protocol : 57600, 8, N, 1");
   UART1_Write(13);                      // EUSART ile ENTER gönderildi
