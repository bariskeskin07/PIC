const unsigned int USB_VENDOR_ID = 0x1111;
...
const struct{
  char bLength;
  char bDscType;
  unsigned int string[29];
  }strd2={
    60,           //sizeof this descriptor string
    0x03,
    {'U','S','B',' ','-',' ','8',' ','a','d','e','t',' ','R','C',' ','m','o','t','o','r',' ','k','o','n','t','r','o','l'}
  };
